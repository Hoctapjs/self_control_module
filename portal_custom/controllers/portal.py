...
class CustomPortal(CustomerPortal):
    ...
    def home(self, **kw):
        ...
        if subordinates or request.env.user.x_is_portal_manager:
            is_manager = True
        ...
        # 4.5 Check if user is a trainer
        is_trainer = employee.job_id.code in ['CT', 'BT']
        ...
        if hasattr(response, 'qcontext'):
            ...
            response.qcontext['is_trainer'] = is_trainer
            response.qcontext['approval_count'] = approval_count
            response.qcontext['activity_count'] = activity_count
